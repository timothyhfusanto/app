...
import alex from "../../../public/images/speakers/alex.jpg";
...
export const speakers = [
  ...
  },
  {
    ...
    panelNum: "IV",
    panel: "Rethinking Technological Harms: The Path Forward in Research on AI and Youth Well-Being",
    panelDesc: "This keynote will explore the challenges and opportunities in researching the impact of AI on youth well-being, emphasizing the need for a nuanced understanding of technological harms.",
    layout: "right",
